...
public class CardLoginScene {
    public static void cardLoginScene(Stage stage,Image background,ImageView backgroundView){
        ...
        enter.setOnAction(event -> {
            ...
            {
                message.setText("Card Number is Not full");
            }
            else
            {
                String extracedCardNumber = cardNumberField.getText();
                AccountService sc = new AccountService();
                BankAccount bankAccount = (BankAccount)sc.search(extracedCardNumber);
                if(bankAccount != null)
                {
                    CardPassword.cardPassword(stage,background,backgroundView,bankAccount);
                }
                else
                {
