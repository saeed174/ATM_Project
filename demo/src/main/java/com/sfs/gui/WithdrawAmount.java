...
public class WithdrawAmount {
    public static void withdrawAmount(Stage stage,Image background,ImageView backgroundView,Account bankAccount)
    {
        ...
        Text Login = new Text("Enter The Amount");
        Login.setStyle(
            "-fx-font-size: 50px;" +
            "-fx-text-fill: #2c3e50;" +
            "-fx-font-weight: bold;" +
        ...
        AmountField.setPromptText("Enter your password");
        ...
        enter.setOnAction(event -> {
            ...
            if(amountValue <= bankAccount.getBalance())
            {
                message.setText("");
                bankAccount.withdrawBalance(amountValue);
            ...
            {
                message.setText("This amount is not available");
            }
        });
